interface IRadiusIcon {
    classProps?: string;
}

export default function RadiusIcon({ classProps }: IRadiusIcon) {
    return (
        <>
            <svg width="100%" height="100%" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" className={classProps} >
