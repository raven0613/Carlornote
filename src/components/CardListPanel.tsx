...
export function SortList({ sortConditionProp, handleSort, isOpen, handleClose }: ISortList) {
    ...
    return (
        <>
            <div ref={nodeRef} className={`flex flex-wrap absolute left-4 bottom-full mb-4 border border-slate-200 gap-2 w-72 h-24 p-3 rounded-lg bg-white shadow-lg shadow-black/20 overflow-y-scroll duration-100 ease-in-out
...
export function TagList({ allTags, selectedTagsProp, handleSelectTag, isOpen, handleClose }: ITagList) {
