...
export default function ImageIcon({ classProps }: IImageIcon) {
    return (
        <>
            <svg className={classProps} width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
